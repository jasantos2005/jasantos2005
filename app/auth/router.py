(venv) root@srv1287626:/opt/automacoes/GSG/gestao/diretoria/dashboards# cat /opt/automacoes/GSG/gestao/diretoria/dashboards/app/auth/router.py
import sqlite3
import os
import bcrypt
...
async def login(response: Response, username: str = Form(...), password: str = Form(...)):
    ...
    return {"status": "success", "redirect": "/dashboard/home"}
...
async def logout_router():
    ...
    return response
(venv) root@srv1287626:/opt/automacoes/GSG/gestao/diretoria/dashboards#
